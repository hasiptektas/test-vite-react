    ...
    const CustomAccordion = ({ children, eventKey }) => {
        ...
        return (
            <div>
                {
                    title && (
                        <div className='d-flex justify-content-between align-items-end flex-row bg-white mb-5'  style={{borderBottom: '1px solid black'}}>
                <span style={{fontSize: '70px', lineHeight:'.8', marginLeft: '64px', paddingTop: '32px'}}>WHY <span style={{fontWeight: 'bold'}}>ME</span></span>
                <div>
                <button
                    type="button"
                    style={{border: 'none', marginBottom: '15px', marginRight: '64px', backgroundColor: 'white' }}
                    onClick={decoratedOnClick}
                >
                    {children}
                </button>
      ...
      <Accordion style={{maxWidth: '1280px', margin: '0 auto'}} >
        <Card style={{backgroundColor: '#F5EFFB', border: 'none'}}>
            ...
            <Card.Body className='bg-white'>
                ...
                <img src="./9.jpg" alt="" width={300} height={300}/>
                <img src="./4.jpg" alt="" width={300} height={300}/>
